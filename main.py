...
from utilities.db_calls import (load_keywords, get_logged_events, init_db)
...
async def init():
    ...
    global email_controller, keywords, time_until_next_prompt, resource_controller, vocal_handler, device_controller
    ...
    email_controller = Email_Main_Controller(CONFIRMED_PROVIDERS, vocal_handler, keywords)
